document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!propiedades_venta || propiedades_venta.length === 0) {
      console.error("Error: propiedades_venta no está definido o está vacío.");
      return;
    }
  
    renderizarPropiedades(ventaContainer, propiedades_venta);
  });
